    ...
    <>
      ...
      <section className="pt-32 sm:pt-40 pb-24">
        <div className="container-tight max-w-3xl">
          ...
          <h1 className="font-display text-5xl sm:text-6xl text-[#0A2540]">Privacy Policy</h1>
          ...
          <div className="mt-10 space-y-8 text-[#475569] leading-relaxed">
            <section>
              <h2 className="font-display text-2xl text-[#0A2540] mb-3">What we collect</h2>
            ...
            <section>
              <h2 className="font-display text-2xl text-[#0A2540] mb-3">How we use it</h2>
            ...
            <section>
              <h2 className="font-display text-2xl text-[#0A2540] mb-3">Cookies</h2>
            ...
            <section>
              <h2 className="font-display text-2xl text-[#0A2540] mb-3">Data retention</h2>
            ...
            <section>
              <h2 className="font-display text-2xl text-[#0A2540] mb-3">Your rights</h2>
            ...
            <section>
              <h2 className="font-display text-2xl text-[#0A2540] mb-3">Third-party links</h2>
