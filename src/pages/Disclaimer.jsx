    ...
    <>
      ...
      <section className="pt-32 sm:pt-40 pb-24">
        <div className="container-tight max-w-3xl">
          ...
          <h1 className="font-display text-5xl sm:text-6xl text-[#0F172A]">Disclaimer</h1>

          <div className="mt-10 p-6 bg-[#0F172A] text-[#F8FAFC] border-l-4 border-[#C2410C]">
          ...
          <div className="mt-10 space-y-8 text-[#475569] leading-relaxed">
            <section>
              <h2 className="font-display text-2xl text-[#0F172A] mb-3">No income or outcome claims</h2>
            ...
            <section>
              <h2 className="font-display text-2xl text-[#0F172A] mb-3">Not regulated advice</h2>
            ...
            <section>
              <h2 className="font-display text-2xl text-[#0F172A] mb-3">Country pathway information</h2>
            ...
            <section>
              <h2 className="font-display text-2xl text-[#0F172A] mb-3">Your responsibility</h2>
