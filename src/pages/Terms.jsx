    ...
    <>
      ...
      <section className="pt-32 sm:pt-40 pb-24">
        <div className="container-tight max-w-3xl">
          <div className="text-xs font-semibold tracking-[0.25em] uppercase text-[#3d97e8] mb-6">Legal</div>
          <h1 className="font-display text-5xl sm:text-6xl text-[#0A2540]">Terms of Service</h1>
          ...
          <div className="mt-10 space-y-8 text-[#475569] leading-relaxed">
            <section>
              <h2 className="font-display text-2xl text-[#0A2540] mb-3">Nature of the service</h2>
            ...
            <section>
              <h2 className="font-display text-2xl text-[#0A2540] mb-3">No guaranteed outcomes</h2>
            ...
            <section>
              <h2 className="font-display text-2xl text-[#0A2540] mb-3">Not legal, financial, or immigration advice</h2>
            ...
            <section>
              <h2 className="font-display text-2xl text-[#0A2540] mb-3">Pricing and engagements</h2>
            ...
            <section>
              <h2 className="font-display text-2xl text-[#0A2540] mb-3">Cancellations and refunds</h2>
            ...
            <section>
              <h2 className="font-display text-2xl text-[#0A2540] mb-3">Community</h2>
            ...
            <section>
              <h2 className="font-display text-2xl text-[#0A2540] mb-3">Acceptable use</h2>
            ...
            <section>
              <h2 className="font-display text-2xl text-[#0A2540] mb-3">Contact</h2>
