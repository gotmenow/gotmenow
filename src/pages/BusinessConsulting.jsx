            ...
            {s.offerings.map((o) => {
              ...
              return (
                <div key={o.title} className="bg-[#F8FAFC] p-8 sm:p-10 flex gap-6">
                  <div className="w-12 h-12 rounded-sm bg-[#000000] text-[#00a99d] flex items-center justify-center flex-shrink-0">
                    <Icon className="w-6 h-6" />
                  </div>
                  <div>
                    <h3 className="font-display text-2xl text-[#000000] mb-2">{o.title}</h3>
